...
export default function Home() {
  ...
  //     router.push('/home');
  //             //  }
  //     // router.push('/home'); // Replace '/home' with the actual URL of your home page
    //   }, 5000); 
  ...
  return (
    <div className='w-full h-screen flex flex-col justify-center items-center'>
            ...
            <p className='text-3xl font-bold text-orange animate__animated animate__flash'>FOODIED</p>
    </div>
              // <WelcomeScreen/> 
    ...
    //         return( <div key={service.id} className='shadow-lg flex flex-col justify-center p-4'>
