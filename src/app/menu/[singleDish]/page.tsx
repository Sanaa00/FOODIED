  ...
  return (
       <div className='lg:mx-36 pt-32 grid gap-x-10 grid-cols-2 h-screen'>
            <div className='flex flex-col justify-between h-96'>
                 <div> <p className='text-black font-bold text-2xl '>{singleDish?.name}</p>
                 <div className='flex justify-between items-center'>
                      <p className='text-orange font-semibold text-lg bg-gray-50 mt-5 px-4 py-1 rounded-full w-fit'>{singleDish?.category}</p>
                      <div className='flex flex-row items-center mt-5'>
                           <div>{singleDish?.stars && <Starts count={singleDish?.stars} />}</div>
