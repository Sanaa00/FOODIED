...
export const services = [    
     {
          ...
          descriptions: "We serve all healthy food here. you can choose any food you like",
          icon:<PiBowlFood className="w-16 h-16 text-orange"/>
     },
     {
          id: 2,
          name: "Best Quality ",
          descriptions: "Our food quality is excellent. you will get exactly what you want here",
          icon:<LuFolderHeart className="w-16 h-16 text-orange"/>
     },
     {
          id: 3,
          name: "Fast Delivery",
          descriptions: "you can say the main goal of our delivery man is to deliver orders quickly . you will receive it shortly after ordering",
